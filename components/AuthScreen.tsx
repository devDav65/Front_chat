...
export default function AuthScreen() {
  ...
  async function handleGoogleSignIn() {
    if (!window.google || !GOOGLE_CLIENT_ID) {
      setLAlert({ msg: 'Google OAuth non configuré.', type: 'error' });
      return;
    }
    setGLoading(true);
    try {
      ...
      setGLoading(false);
      setLAlert({ msg: 'Erreur Google Sign-In.', type: 'error' });
    }
  }

  async function handleGoogleToken(tokenResponse: { access_token: string }) {
